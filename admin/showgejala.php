...
<html>
	...
	<body class="w3-container">
		<nav class="navtop">
			...
			<div class="content w3-text-blue">
				...
				<?php
					...
					if ($jum = mysqli_num_rows($result)) {
    					while($row = mysqli_fetch_array($result)) { 
							...
							echo '<form action="hapusgejala.php" method="post">';
							...
							echo '<div class="container"  align="right">';
								...
								echo '<table>';
								echo '<a href=ndextambahgejala.php class="w3-btn w3-blue">Tambah gejala</a>';
								echo '<input type="submit" class="w3-btn w3-red" value="Hapus gejala">';
								echo '</table>';
